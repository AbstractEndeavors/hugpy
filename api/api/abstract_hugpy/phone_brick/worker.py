...
from .schemas import DetectorConfig, WorkerConfig

_DEFAULT_MODEL_PATH = os.path.expanduser("~/phone-brick/ppe-tanishjain-6class.onnx")
...
def build_app(config: WorkerConfig | None = None, worker: Worker | None = None):
    ...
    app = Flask("abstract_hugpy_phone_brick_worker")
