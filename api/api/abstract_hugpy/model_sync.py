...
worker agent.
    ...
    python -m abstract_hugpy.model_sync --central https://abstractgpt.ai --list

    # pull one model (or several), or everything
    python -m abstract_hugpy.model_sync --central https://abstractgpt.ai --model DAN-Qwen3-1.7B
    python -m abstract_hugpy.model_sync --central https://abstractgpt.ai --all

As a library:

    from abstract_hugpy.model_sync import list_models, pull_model, pull_models
    pull_models("https://abstractgpt.ai", ["DAN-Qwen3-1.7B"])
"""
...
logger = logging.getLogger("abstract_hugpy.model_sync")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="abstract_hugpy.model_sync")
    parser.add_argument("--central", required=True,
                        help="central base URL, e.g. https://abstractgpt.ai")
