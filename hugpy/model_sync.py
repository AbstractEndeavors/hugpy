...
worker agent.
    ...
    python -m hugpy.model_sync --central https://hugpy.ai --list

    # pull one model (or several), or everything
    python -m hugpy.model_sync --central https://hugpy.ai --model DAN-Qwen3-1.7B
    python -m hugpy.model_sync --central https://hugpy.ai --all

As a library:

    from hugpy.model_sync import list_models, pull_model, pull_models
...
logger = logging.getLogger("hugpy.model_sync")
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(prog="hugpy.model_sync")
